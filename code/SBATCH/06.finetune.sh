...
#SBATCH --output=/hpc/group/wenhaolab/projects/corporate-control/code/SBATCH/logs/finetune.out
#SBATCH --error=/hpc/group/wenhaolab/projects/corporate-control/code/SBATCH/logs/finetune.err
